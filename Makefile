...
REPLACES_PRODUCT_CSV   ?= 2.3.6
REPLACES_COMMUNITY_CSV ?= 2.3.6
VERSION                ?= development
...
$(addprefix collect-templates-,$(SUPPORTED_VERSIONS)): collect-templates-%:
	...
	find ${RESOURCES_DIR}/smcp-templates/v${version}/ -maxdepth 1 -type f ! -name "maistra" ! -name "servicemesh" -exec rsync -av {} ${TEMPLATES_OUT_DIR}/v${version}/ \;
