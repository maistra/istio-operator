...
import (
	...
	"github.com/maistra/istio-operator/controllers/hacks"
)
...
func add(mgr manager.Manager, r *ControlPlaneReconciler) error {
	...
	if err = c.Watch(&source.Kind{Type: &v2.ServiceMeshControlPlane{}}, &handler.InstrumentedEnqueueRequestForObject{}); err != nil {
		return err
	}
	...
	if err = c.Watch(&source.Kind{Type: &appsv1.DaemonSet{}},
		runtimeHandler.EnqueueRequestsFromMapFunc(func(obj client.Object) []reconcile.Request {
...
var enqueueRequestForSMCP = runtimeHandler.EnqueueRequestsFromMapFunc(
