...
func add(mgr manager.Manager, r *PodLocalityReconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &v1.Pod{}}, &handler.InstrumentedEnqueueRequestForObject{}, predicate.Funcs{
	...
	err = c.Watch(&source.Kind{Type: &v1.Node{}}, 
		runtimeHandler.EnqueueRequestsFromMapFunc(func(a client.Object) []reconcile.Request {
			list := &v1.PodList{}
