...
//+kubebuilder:rbac:groups=maistra.maistra.io,resources=customresourcedefinitions,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=maistra.maistra.io,resources=customresourcedefinitions/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=maistra.maistra.io,resources=customresourcedefinitions/finalizers,verbs=update
...
func (r *CustomResourceDefinitionReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&maistrav2.CustomResourceDefinition{}).
		Complete(r)
}
