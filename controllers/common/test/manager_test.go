...
func TestFakeManager(t *testing.T) {
	...
	// create watch
	if err := c.Watch(&source.Kind{Type: &maistrav1.ServiceMeshControlPlane{}}, &handler.InstrumentedEnqueueRequestForObject{}); err != nil {
	...
	if err := c.Watch(&source.Kind{Type: &corev1.Service{}}, &handler.InstrumentedEnqueueRequestForObject{}); err != nil {
		t.Errorf("Unexpected error creating watch: %v", err)
	}
