...
func SkipReconciliationUntilCacheSynced(ctx context.Context, namespacedName types.NamespacedName) {
	...
	earliestReconciliationTimes, ok := ctx.Value(key).(map[types.NamespacedName]time.Time)
	if !ok {
