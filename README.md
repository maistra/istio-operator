...
sed 's/latest/4.1/g' https://raw.githubusercontent.com/openshift/elasticsearch-operator/release-4.1/manifests/05-deployment.yaml | oc create -n openshift-logging -f -
```
