...
require (
	...
	istio.io/client-go v1.19.0-alpha.1.0.20231020024509-61265b7bd855
	istio.io/istio v0.0.0-20231020004805-b80856a2e9db
	k8s.io/api v0.28.3
...
require (
	...
	istio.io/api v1.19.0-alpha.1.0.20231019231339-d64c2697d3e0 // indirect
