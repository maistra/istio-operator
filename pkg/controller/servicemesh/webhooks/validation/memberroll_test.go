...
func TestMemberValidation(t *testing.T) {
	testCases := []struct {
		...
		{valid: false, members: "", message: ".spec.members contains invalid value ''. Must be either a valid namespace name or a pattern. Valid patterns are: '*', 'my-namespace-123-*', etc."},
		{valid: false, members: "-badname", message: ".spec.members contains invalid value '-badname'. Must be either a valid namespace name or a pattern. Valid patterns are: '*', 'my-namespace-123-*', etc."},
		{valid: false, members: "badname-", message: ".spec.members contains invalid value 'badname-'. Must be either a valid namespace name or a pattern. Valid patterns are: '*', 'my-namespace-123-*', etc."},
		{valid: false, members: "bad%name", message: ".spec.members contains invalid value 'bad%name'. Must be either a valid namespace name or a pattern. Valid patterns are: '*', 'my-namespace-123-*', etc."},
		...
		{valid: false, members: "*book", message: ".spec.members contains invalid value '*book'. Must be either a valid namespace name or a pattern. Valid patterns are: '*', 'my-namespace-123-*', etc."},
