...
func (v *versionStrategyV3_0) SetImageValues(_ context.Context, _ *common.ControllerResources, smcpSpec *v1.ControlPlaneSpec) error {
	...
	if err := common.UpdateField(smcpSpec.Istio, "global.proxy_init.image", common.Config.OLM.Images.V3_0.ProxyV2); err != nil {
		return err
	}
...
func (v *versionStrategyV3_0) IsClusterScoped(spec *v2.ControlPlaneSpec) (bool, error) {
	return true, nil
}
...
func (v *versionStrategyV3_0) ValidateUpdate(ctx context.Context, cl client.Client, oldSMCPObject, newSMCPObject metav1.Object) error {
...
func (v *versionStrategyV3_0) ValidateRequest(ctx context.Context, cl client.Client, req admission.Request, obj metav1.Object) admission.Response {
	smcp, err := toSMCP(obj)
	if err != nil {
...
func (v *versionStrategyV3_0) Render(ctx context.Context, cr *common.ControllerResources, cniConfig cni.Config,
	...
	err = unstructured.SetNestedField(
		spec.Istio.GetContent(),
		v.GetCNINetworkName(),
		"sidecarInjectorWebhook",
		"injectedAnnotations",
		"k8s.v1.cni.cncf.io/networks.istio_cni_network",
	)
	if err != nil {
...
func (v *versionStrategyV3_0) validateGlobal(
...
func (v *versionStrategyV3_0) createMemberRoll(ctx context.Context, cr *common.ControllerResources, smcp *v2.ServiceMeshControlPlane) error {
	log := common.LogFromContext(ctx)
