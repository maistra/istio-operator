...
func (v *versionStrategyV2_2) ValidateDowngrade(ctx context.Context, cl client.Client, smcp *v2.ServiceMeshControlPlane) error {
	// TODO: what might prevent us from downgrading?
	return nil
}

func (v *versionStrategyV2_2) ValidateUpgrade(ctx context.Context, cl client.Client, smcp *v2.ServiceMeshControlPlane) error {
	// TODO: what might prevent us from upgrading?
	return nil
}

func (v *versionStrategyV2_2) ValidateUpdate(ctx context.Context, cl client.Client, oldSMCP, newSMCP *v2.ServiceMeshControlPlane) error {
	return nil
}

func (v *versionStrategyV2_2) ValidateRequest(ctx context.Context, cl client.Client, req admission.Request, smcp *v2.ServiceMeshControlPlane) admission.Response {
...
func (v *versionStrategyV2_2) Render(ctx context.Context, cr *common.ControllerResources, cniConfig cni.Config,
	...
	for name, chartDetails := range v2_2ChartMapping {
		...
		if chartDetails.enabledField == "" || isComponentEnabled(spec.Istio, chartDetails.enabledField) {
			...
			chart := path.Join(v.GetChartsDir(), v2_2ChartMapping[name].path)
...
func (v *versionStrategyV2_2) renderIngressGateway(name, namespace, kubeVersion string, gateways map[string]interface{},
...
func (v *versionStrategyV2_2) renderEgressGateway(name, namespace, kubeVersion string, gateways map[string]interface{},
	values *v1.HelmValues, userIDAutoassigned bool,
) (map[string][]manifest.Manifest, map[string]interface{}, error) {
...
func (v *versionStrategyV2_2) renderGateway(name, namespace, kubeVersion string, chartPath string, typeName string,
