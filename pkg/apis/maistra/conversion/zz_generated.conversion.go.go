...
func RegisterConversions(s *runtime.Scheme) error {
	if err := s.AddGeneratedConversionFunc((*v1.ControlPlaneSpec)(nil), (*v2.ControlPlaneSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_ControlPlaneSpec_To_v2_ControlPlaneSpec(a.(*v1.ControlPlaneSpec), b.(*v2.ControlPlaneSpec), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v2.ControlPlaneSpec)(nil), (*v1.ControlPlaneSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v2_ControlPlaneSpec_To_v1_ControlPlaneSpec(a.(*v2.ControlPlaneSpec), b.(*v1.ControlPlaneSpec), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1.ControlPlaneStatus)(nil), (*v2.ControlPlaneStatus)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_ControlPlaneStatus_To_v2_ControlPlaneStatus(a.(*v1.ControlPlaneStatus), b.(*v2.ControlPlaneStatus), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v2.ControlPlaneStatus)(nil), (*v1.ControlPlaneStatus)(nil), func(a, b interface{}, scope conversion.Scope) error {
