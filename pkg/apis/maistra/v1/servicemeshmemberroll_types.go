...
// spec.members or defines a member selector. In both cases, the list of members
// is dynamic (i.e. isn't static), as namespaces can become and stop being members
// with no need to modify the SMMR.
