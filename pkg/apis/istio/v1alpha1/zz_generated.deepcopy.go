...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ThreeScaleServerSpec) DeepCopyInto(out *ThreeScaleServerSpec) {
	*out = *in
	if in.ServiceId != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ThreeScaleServerSpec.
func (in *ThreeScaleServerSpec) DeepCopy() *ThreeScaleServerSpec {
	if in == nil {
		return nil
	}
	out := new(ThreeScaleServerSpec)
	in.DeepCopyInto(out)
	return out
}
